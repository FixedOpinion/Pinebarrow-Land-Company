...
The current runtime includes C2.1–C2.3: shared drag selection, footprint snapshots, and live mine/warehouse siting. C2.4 is next and must connect residential lots, house upgrades, and road corridors to that same project route; C2.5 remains the browser/mobile integration gate. No later housing, school, research, or industry checkpoint may reintroduce fixed auto-adjacent placement behavior.
