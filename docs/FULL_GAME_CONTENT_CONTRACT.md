...
The current runtime includes C2.1–C2.4: shared drag selection, footprint snapshots, live mine/warehouse siting, approved residential lots and house upgrades, and project-backed road corridors. C2.5 remains the browser/mobile integration gate. No later housing, school, research, or industry checkpoint may reintroduce fixed auto-adjacent placement behavior.
